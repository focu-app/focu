...
const faqs = [
  ...
  },
  {
    ...
    answer: "Focu does not collect any data from the user. All data is stored locally on your device. AI features are running on your own machine and work even offline.",
  },
]
